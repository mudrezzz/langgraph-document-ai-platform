...
try {
    ...
    & $pythonExe "$backendRoot\scripts\smoke_artifact_writer_mcp.py" --prefix $Prefix --limit $Limit --offset $Offset --artifact-type $ArtifactType
}
finally {
    Pop-Location
