...
def main() -> None:
    ...
    payload = {
        ...
        "lookup_source_kind": lookup.get("source_provenance", {}).get("source_kind"),
        "lookup_table_title": lookup.get("source_provenance", {}).get("table_title"),
        "lookup_row_index": lookup.get("source_provenance", {}).get("row_index"),
